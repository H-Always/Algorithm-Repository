 ...
 * @Version: 1.0
 */
public class TestFindLadders {
    public static void main(String[] args) {
        FindLadders ys = new FindLadders();


        String beginWord = "cet";
        String endWord = "ism";
        String[] s = {"kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz", "brr", "gay", "sip", "kay",
        ...
        List<List<String>> res = ys.findLadders_DFS(beginWord, endWord, wordList);
